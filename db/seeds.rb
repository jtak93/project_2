...
b1 = Budget.create(budget: 5000, budget_date: Date.current.strftime("%b %Y"), user: u1)
...
e1 = Expense.create(amount:300, expense_date: Date.current, budget: b1, expense_category_id: ec1.id)
